    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        <div class="card-body">
            <x-admin.form-section label="اسلایدر ابتدا">
                <x-admin.button class="btn btn-light-primary font-weight-bolder btn-sm" content="افزودن " wire:click="addSlider('new')" />
                <table class="table table-striped table-bordered dt-responsive">
                    ...
                    @foreach($sliders as $key => $value)
                        <tr>
                            <td>{!! $value['slider'] ?? '' !!}</td>
                            <td>
                                <button type="button"  wire:click="addSlider('{{$key}}')" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2">
                                ...
                                <x-admin.delete-btn wire:click="unSetSlider({{$key}})" />
            ...
            <x-admin.modal-page id="slider" title="{{ $titleSlider }}" wire:click="storeSlider">
                <x-admin.forms.validation-errors/>
                <x-admin.forms.full-text-editor id="content" label="عنوان*" wire:model.defer="slider"/>
