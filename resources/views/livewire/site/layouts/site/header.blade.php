        ...
        <div class="header-body border-0">
                            ...
                            <div class="header-row">
                                <nav class="header-nav-top">
                                    <ul class="nav nav-pills text-uppercase text-2">
                                        <li class="nav-item nav-item-anim-icon pr-2">
                                            <a class="nav-link pl-0 text-light opacity-7" href="{{route('home')}}">{{ $data['title'] }}</a>
                                        </li>
            ...
            <div class="header-container container">
                <div class="header-row py-3">
                    <div class="header-column justify-content-start w-50 order-md-1 d-none d-flex">
                        <div class="header-row">
                                            ...
                                            <ul class="nav nav-pills flex-column flex-lg-row" >
                                                ...
                                                <li class="dropdown d-flex align-items-center">
                                                    @if(auth()->check())
                                                        ...
                                                        /
                                                        <a class="dropdown-item px-1" href="{{route('logout')}}"> خروج </a>
                        ...
                        <div class="header-column">
                            <div class="header-row justify-content-end">
                                <div class="header-nav p-0">
                                    <div class="header-nav header-nav-line header-nav-divisor header-nav-spaced justify-content-lg-start">
